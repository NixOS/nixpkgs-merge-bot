...
from nixpkgs_merge_bot.webhook.handler import GithubWebHook, HttpResponse

TEST_ROOT = Path(__file__).parent
TEST_DATA = TEST_ROOT / "data"


def test_get(webhook_client: WebhookClient):
...
def test_post(webhook_client: WebhookClient):
    client = webhook_client.http_connect()
    ...
    hook = GithubWebHook(webhook_client.server_sock, webhook_client.addr, "foo")
